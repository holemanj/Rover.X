 ...
 * This holds header level info for hardware-level initialization routines
 */
...
/* Configuration bit setup goes here - they are implemented by including this */
/* header, even if no other pic18_init code is used */
